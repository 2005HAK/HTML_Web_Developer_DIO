function muda(elemento) {
    ...
    switch (valor) {
        case 1:
            capa.style.backgroundImage = "linear-gradient(rgba(0,0,0,.5),rgba(0,0,0,.5)100%), url(/Recriando_a_Insterface_da_Netflix/img/solo.jpg)";
            ...
            break;
        case 2:
            capa.style.backgroundImage = "linear-gradient(rgba(0,0,0,.5),rgba(0,0,0,.5)100%), url(/Recriando_a_Insterface_da_Netflix/img/tbate.jpg)";
            ...
            break;
        case 3:
            capa.style.backgroundImage = "linear-gradient(rgba(0,0,0,.5),rgba(0,0,0,.5)100%), url(/Recriando_a_Insterface_da_Netflix/img/max.jpg)";
            ...
            break;
        case 4:
            capa.style.backgroundImage = "linear-gradient(rgba(0,0,0,.5),rgba(0,0,0,.5)100%), url(/Recriando_a_Insterface_da_Netflix/img/mercenary.jpg)";
            ...
            break;
        case 5:
            capa.style.backgroundImage = "linear-gradient(rgba(0,0,0,.5),rgba(0,0,0,.5)100%), url(/Recriando_a_Insterface_da_Netflix/img/return.jpg)";
            ...
            break;
        case 6:
            capa.style.backgroundImage = "linear-gradient(rgba(0,0,0,.5),rgba(0,0,0,.5)100%), url(/Recriando_a_Insterface_da_Netflix/img/onePiece.jpg)";
            ...
            break;
        case 7:
            capa.style.backgroundImage = "linear-gradient(rgba(0,0,0,.5),rgba(0,0,0,.5)100%), url(/Recriando_a_Insterface_da_Netflix/img/world.jpg)";
